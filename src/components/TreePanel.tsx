...
import { Schema, Tree } from "@fool-builder/core";
import {
  ChevronDownIcon,
  ChevronRightIcon,
  DragHandleIcon,
  SmallAddIcon,
} from "@fool-builder/icons";
import { CofeTree } from "@fool-builder/types";
import { Paper, PaperProps } from "@fool-builder/ui";
import { isMobile } from "@fool-builder/utils";
import {
  DndContext,
  MeasuringStrategy,
  MouseSensor,
